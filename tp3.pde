...
float t1Original, t2Original, t3Original,  t4Original, t5Original, t6Original, t7Original, t8Original, t9Original;
...
void figura(float x, float y, float t) {
  ...
  boolean mouseEncima = distancia < t / 2;
  pushMatrix();
  translate(x, y);
  if (mouseEncima) {
